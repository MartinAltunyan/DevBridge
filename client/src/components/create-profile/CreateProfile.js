                        ...
                        <div className='col-md-8 m-auto'>
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <TextFieldGroup
                                    ...
                                    onChange={this.onChange}
                                    error={errors.skills}
                                    info="Please use comma seperated values (eg. JavaScript,PHP,Python,JAVA)"
                                ...
                                <TextFieldGroup
                                    ...
                                    info="If you want you latest repos and Github link, include your Github username"
                                ...
                                {socialInputs}
                                <input type='submit' value='Submit' className='btn btn-info btn btn-block mt-4' />
                            </form>
